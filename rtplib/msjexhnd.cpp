...
MSJExceptionHandler::MSJExceptionHandler( )
{
	...
	//printf("nnnnnnnnnnnnnnnnnnnnnncreate ex\n");
	//PTSTR pszLogFileName=_T("c:\\AudioLog\\cr.rpt");
	SetErrorMode(SEM_NOGPFAULTERRORBOX);

    // Install the unhandled exception filter function
    m_previousFilter = SetUnhandledExceptionFilter(MSJUnhandledExceptionFilter);
	//printf("========================set exception handle=%s\n", m_previousFilter?"no null":"null");
	...
	//this->SetLogFileName(pszLogFileName);
	SetLogFileName(_T("c:\\ipcsdk_crash"));
	//printf("create mmmmmmmmmmmm\n");
...
MSJExceptionHandler::~MSJExceptionHandler( )
{
	//printf("dddddddddddddddddddddddddd============delete ex\n");
    SetUnhandledExceptionFilter( m_previousFilter );
	//printf("delete mmmmmmmmmmmmm\n");
}
    ...
    PEXCEPTION_POINTERS pExceptionInfo )
{
	...
	SYSTEMTIME tm;
	GetLocalTime(&tm);
	_tprintf( _T("%4dÄê%2dÔÂ%2dÈÕ %2d:%2d:%2d\r\n"),
