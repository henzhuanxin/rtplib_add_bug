...
const struct trtp_rtp_packet_s* tdav_video_jb_pkt_find_by_seq(struct tdav_video_jb_s* self, unsigned  short seq);
void tdav_video_jb_lock(struct tdav_video_jb_s *self);
void tdav_video_jb_unlock(struct tdav_video_jb_s *self);
TDAV_END_DECLS
